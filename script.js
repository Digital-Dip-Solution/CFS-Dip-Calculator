...
function exportHistoryPDF(){
  ...
  doc.text('Chaudhary Filling Station',14,18);
  doc.setFontSize(11);
...
function shareHistoryWhatsApp(){
  ...
  let msg='*Chaudhary Filling Station — Fuel Dip Readings*\n\n';
  recent.forEach(e=>{
...
const CHART_TANKS={ t50:{data:tank50,label:'Tank 1'}, t25:{data:tank25,label:'Tank 2'} };
